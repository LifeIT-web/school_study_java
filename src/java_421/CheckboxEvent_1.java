...
public class CheckboxEvent_1 extends Frame{
	...
	public CheckboxEvent_1(String title) {
		...
		q1 = new Label("1. 다음중 ActionEvent 의 " + " actionPerformed() 메소드가 호출되는 경우는 ? ");
		
		q1cb1 = new Checkbox("Button 을 눌럿을때");
		q1cb2 = new Checkbox("TextField 에서 Enter 키를 눌렀을때");
		q1cb3 = new Checkbox("MenuItem를 클릭햇을때");
		q1cb4 = new Checkbox("List에서 더블 클릭으로 Item을 선택했을때");
		
		q2 = new Label("2. Frame 의 기본 LayoutManager 는 ?(하나만 골라) ");
		...
		end.addActionListener(new Handler());
...
class Handler implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) {
		...
		score.setText("당신의 점수는 " + totalScore + " 입니다.");
	}
