...
public class Images_2 extends Frame implements ActionListener{

	Image img;
	XCanvas_3 canvas;
	
	Button[] btn = new Button[7];
	String[] btn_str = {"기본", "확대", "축소", "상하", "좌우", "전부", "이미지 불러오기"};
	...
	String ss = "src\\images\\sea.jpg";
	
	public Images_2(String title) {
		super(title);
		...
		txt = new TextField("src\\images\\winter.jpg", 20);
	...
	class XCanvas_3 extends Canvas
	{
		...
		public void paint(Graphics g) {
			...
			case 좌우:
				...
				g.drawImage(img, img.getWidth(this), 0, 0, img.getHeight(this),
							0, 0, img.getWidth(this), img.getHeight(this), this);
				break;
				
			case 상하:

				g.drawImage(img, 0, img.getHeight(this), img.getWidth(this), 0,
							0, 0, img.getWidth(this), img.getHeight(this), this);
				break;
				
			case 전부:
				
				g.drawImage(img, img.getHeight(this), img.getWidth(this), 0, 0,
							0, 0, img.getWidth(this), img.getHeight(this), this);
